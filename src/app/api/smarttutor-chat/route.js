...
`;
    ...
    console.error("SmartTutor OpenAI API error:", error);

    const message = error?.message || "";

    let reply =
      "The AI service is not connected properly. Please check your OpenAI API key, billing, and terminal error.";
    ...
    if (
      ...
      reply =
        "OpenAI API quota or billing is not active. Please add credits or billing in your OpenAI Platform account, then restart the server.";
    }
    ...
    if (
      ...
      reply =
        "Your OpenAI API key is incorrect or inactive. Please create a new API key, paste it in .env.local, and restart the server.";
    }
